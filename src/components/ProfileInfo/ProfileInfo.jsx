    ...
    <>
      ...
      <div style={{ width: '100%' }} className="profile">
        <div style={{ width: '100%' }} className="ui two column very relaxed grid">
          ...
          <div style={{ backgroundColor: 'rgb(0,103,164)', backgroundImage: `url(/All.png)`, backgroundPosition:'left', backgroundRepeat: 'no-repeat' }} id="hero-img" className="ui segment">
